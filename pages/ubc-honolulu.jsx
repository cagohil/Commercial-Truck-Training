      ...
      <div className="container mb-50">
        <div className="section-title text-center m-20 wow fadeInUp delay-0-2s">
          ...
          <form
            ...
            method="post"
          >
            <h4 className="text-start">SALT LAKE CITY Ultimate Boot Camp Registration</h4>
            <p className="text-start">
            You are officially registering for our Salt Lake City Ultimate Boot Camp by submitting this form.
              <br />
              The event is July 18-19, 2024 at Black Ridge Fleet Center in West Valley City, Utah.
              <br />
